...
namespace RBI.BUS.BUSMSSQL_CAL
{
    class MSSQL_DM_CAL
    {
        ...
        public DateTime COMPONET_INSTALL_DATE { set; get; }
        ...
        private float DF_THIN(float age)
        {
        ...
        private float DF_LINNING(float age)
        {
            float Fdl = 1, Fom = 1;
        ...
        private int API_EXTERNAL_CORROSION_TEMP()
        {
            ...
            int[] data = { -12, -8, 6, 32, 71, 107, 121, 121, 121 };
        ...
        {
            DateTime AGE_COAT = COMPONET_INSTALL_DATE;
            if (EXTERN_COAT_QUALITY == "High coating quality")
                AGE_COAT = COMPONET_INSTALL_DATE.AddYears(15);
            else if (EXTERN_COAT_QUALITY == "Medium coating quality")
                AGE_COAT = COMPONET_INSTALL_DATE.AddYears(5);
            else
                AGE_COAT = COMPONET_INSTALL_DATE;
