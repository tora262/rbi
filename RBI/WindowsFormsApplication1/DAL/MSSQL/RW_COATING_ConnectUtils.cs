                ...
                using (DbDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        if (reader.HasRows)
                        {
                            ...
                            obj.ExternalCoating = reader.GetOrdinal("ExternalCoating");
                            obj.ExternalInsulation = reader.GetOrdinal("ExternalInsulation");
                            obj.InternalCladding = reader.GetOrdinal("InternalCladding");
                            obj.InternalCoating = reader.GetOrdinal("InternalCoating");
                            obj.InternalLining = reader.GetOrdinal("InternalLining");
                            ...
                            obj.InsulationContainsChloride = reader.GetOrdinal("InsulationContainsChloride");
                            ...
                            obj.SupportConfigNotAllowCoatingMaint = reader.GetOrdinal("SupportConfigNotAllowCoatingMaint");
                            list.Add(obj);
                        }
                    }
                }
